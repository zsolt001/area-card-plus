...
<div class="container" @click="${()=>this._handleClick()}">
          ...
          <div class="alerts">
            ${Gt.map((t=>t in o?this._deviceClasses[t].map((e=>{var i,s,n;const a=o[t].filter((t=>(t.attributes.device_class||"default")===e&&"on"===t.state)),r=null===(s=null===(i=this._config)||void 0===i?void 0:i.customization_alert)||void 0===s?void 0:s.find((t=>t.type===e)),c=null==r?void 0:r.color,l=null==r?void 0:r.icon,h=a.length;return h>0?q`
  ...
  ${this._config.show_active?null===(e=this._config.toggle_domains)||void 0===e?void 0:e.map((t=>{var e,i,s;if(!(t in o))return V;const n=null===(i=null===(e=this._config)||void 0===e?void 0:e.customization_domain)||void 0===i?void 0:i.find((e=>e.type===t)),a=null==n?void 0:n.color,r=null==n?void 0:n.icon,c=o[t].filter((t=>!Zt.includes(t.state)&&!Jt.includes(t.state))).length;return c>0?q`
        ...
        `}))}
          ...
          <div class="bottom">
            ...
            ${Xt.map((t=>{if(!(t in o))return"";const e=o[t].filter((t=>{const e=t.attributes.hvac_action;return!Zt.includes(t.state)&&!Jt.includes(t.state)||e&&("idle"!==e||"off"===e)})).map((t=>`${t.attributes.temperature||"N/A"}°C`));return 0===e.length?"":q`
                (${e.join(", ")})
              `}))}
            </div>
          </div>
