...
<div class="container" @click="${()=>this._handleClick()}">
          ...
          <div class="alerts">
            ${Xe.map((e=>e in a?this._deviceClasses[e].map((t=>{var i,s,o;const n=a[e].filter((e=>(e.attributes.device_class||"default")===t&&"on"===e.state)),r=null===(s=null===(i=this._config)||void 0===i?void 0:i.customization_alert)||void 0===s?void 0:s.find((e=>e.type===t)),c=null==r?void 0:r.color,l=null==r?void 0:r.icon,h=n.length;return h>0?V`
                      <div class="icon-with-count" @click=${i=>this._toggle(i,e,t)}>
                        <ha-state-icon
                          class="alert" style=${c?`color: var(--${c}-color);`:(null===(o=this._config)||void 0===o?void 0:o.alert_color)?`color: ${this._config.alert_color};`:W}
                          .icon=${l||this._getIcon(e,h>0,t)}
                        ></ha-state-icon>
          ...
          <div class="buttons">
            ${this._config.show_active?null===(t=this._config.toggle_domains)||void 0===t?void 0:t.map((e=>{var t,i,s;if(!(e in a))return W;if("climate"===e)return W;const o=null===(i=null===(t=this._config)||void 0===t?void 0:t.customization_domain)||void 0===i?void 0:i.find((t=>t.type===e)),n=null==o?void 0:o.color,r=null==o?void 0:o.icon,c=a[e].filter((e=>!Je.includes(e.state)&&!Qe.includes(e.state))).length;return c>0?V`
                    <div
                    ...
                    >
                      <ha-state-icon
                        ...
                        .domain=${e}
                        .icon=${r||this._getIcon(e,c>0)}
                      ></ha-state-icon>
                      <span class="active-count text-small ${c>0?"on":"off"}">
                        ${c}
                      </span>
                    </div>
                  `:W})):null===(i=this._config.toggle_domains)||void 0===i?void 0:i.map((e=>{var t,i,s;if(!(e in a))return W;if("climate"===e)return W;const o=null===(i=null===(t=this._config)||void 0===t?void 0:t.customization_domain)||void 0===i?void 0:i.find((t=>t.type===e)),n=null==o?void 0:o.color,r=null==o?void 0:o.icon,c=a[e].filter((e=>!Je.includes(e.state)&&!Qe.includes(e.state))).length;return V`
                  <div
                    class="icon-with-count hover"
                    @click=${t=>this._toggle(t,e)}
                  >
          ...
          <div class="bottom">
            <div>
              ...
              <div class="sensors">
                ${Ge.map((e=>{if(!(e in a))return W;const t=this._deviceClasses[e].map(((t,i,s)=>{var o,n,r;if(0===a[e].filter((e=>e.attributes.device_class===t)).length)return W;const c=this._average(e,t),l=null===(n=null===(o=this._config)||void 0===o?void 0:o.customization_sensor)||void 0===n?void 0:n.find((e=>e.type===t)),h=(null==l?void 0:l.color)||(null===(r=this._config)||void 0===r?void 0:r.sensor_color);return V`
                        <span
    ...
    `}};Ye([me({attribute:!1})],nt.prototype,"hass",void 0),Ye([pe()],nt.prototype,"_config",void 0),Ye([pe()],nt.prototype,"_areas",void 0),Ye([pe()],nt.prototype,"_devices",void 0),Ye([pe()],nt.prototype,"_entities",void 0),Ye([pe()],nt.prototype,"_showPopup",void 0),nt=Ye([he("custom-area-card")],nt);class at{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}const{I:rt}=ae,ct=()=>document.createComment(""),lt=(e,t,i)=>{const s=e._$AA.parentNode,o=void 0===t?e._$AB:t._$AA;if(void 0===i){const t=s.insertBefore(ct(),o),n=s.insertBefore(ct(),o);i=new rt(t,n,e,e.options)}else{const t=i._$AB.nextSibling,n=i._$AM,a=n!==e;if(a){let t;i._$AQ?.(e),i._$AM=e,void 0!==i._$AP&&(t=e._$AU)!==n._$AU&&i._$AP(t)}if(t!==o||a){let e=i._$AA;for(;e!==t;){const t=e.nextSibling;s.insertBefore(e,o),e=t}}}return i},ht=(e,t,i=e)=>(e._$AI(t,i),e),dt={},ut=e=>{e._$AP?.(!1,!0);let t=e._$AA;const i=e._$AB.nextSibling;for(;t!==i;){const e=t.nextSibling;t.remove(),t=e}},mt=(e,t,i)=>{const s=new Map;for(let o=t;o<=i;o++)s.set(e[o],o);return s},pt=(e=>(...t)=>({_$litDirective$:e,values:t}))(class extends at{constructor(e){if(super(e),2!==e.type)throw Error("repeat() can only be used in text expressions")}dt(e,t,i){let s;void 0===i?i=t:void 0!==t&&(s=t);const o=[],n=[];let a=0;for(const t of e)o[a]=s?s(t,a):a,n[a]=i(t,a),a++;return{values:n,keys:o}}render(e,t,i){return this.dt(e,t,i).values}update(e,[t,i,s]){const o=(e=>e._$AH)(e),{values:n,keys:a}=this.dt(t,i,s);if(!Array.isArray(o))return this.ut=a,n;const r=this.ut??=[],c=[];let l,h,d=0,u=o.length-1,m=0,p=n.length-1;for(;d<=u&&m<=p;)if(null===o[d])d++;else if(null===o[u])u--;else if(r[d]===a[m])c[m]=ht(o[d],n[m]),d++,m++;else if(r[u]===a[p])c[p]=ht(o[u],n[p]),u--,p--;else if(r[d]===a[p])c[p]=ht(o[d],n[p]),lt(e,c[p+1],o[d]),d++,p--;else if(r[u]===a[m])c[m]=ht(o[u],n[m]),lt(e,o[d],o[u]),u--,m++;else if(void 0===l&&(l=mt(a,m,p),h=mt(r,d,u)),l.has(r[d]))if(l.has(r[u])){const t=h.get(a[m]),i=void 0!==t?o[t]:null;if(null===i){const t=lt(e,o[d]);ht(t,n[m]),c[m]=t}else c[m]=ht(i,n[m]),lt(e,o[d],i),o[t]=null;m++}else ut(o[u]),u--;else ut(o[d]),d++;for(;m<=p;){const t=lt(e,c[p+1]);ht(t,n[m]),c[m++]=t}for(;d<=u;){const e=o[d++];null!==e&&ut(e)}return this.ut=a,((e,t=dt)=>{e._$AH=t})(e,c),q}});var _t=function(e,t,i,s){var o,n=arguments.length,a=n<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,s);else for(var r=e.length-1;r>=0;r--)(o=e[r])&&(a=(n<3?o(a):n>3?o(t,i,a):o(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};class ft extends ce{constructor(){super(...arguments),this.SelectOptions=[],this._entityKeys=new WeakMap}_getKey(e){return this._entityKeys.has(e)||this._entityKeys.set(e,Math.random().toString()),this._entityKeys.get(e)}render(){return this.hass?V`
      ...
      `}}_t([me({attribute:!1})],ft.prototype,"hass",void 0),_t([me({type:Array})],ft.prototype,"SelectOptions",void 0);let gt=class extends ft{constructor(){super(...arguments),this.customizationChangedEvent="config-changed"}get customization(){return this.customization_domain}};_t([me({attribute:!1})],gt.prototype,"customization_domain",void 0),gt=_t([he("domain-items-editor")],gt);let vt=class extends ft{constructor(){super(...arguments),this.customizationChangedEvent="config-changed"}get customization(){return this.customization_alert}};_t([me({attribute:!1})],vt.prototype,"customization_alert",void 0),vt=_t([he("alert-items-editor")],vt);let bt=class extends ft{constructor(){super(...arguments),this.customizationChangedEvent="config-changed"}get customization(){return this.customization_sensor}};_t([me({attribute:!1})],bt.prototype,"customization_sensor",void 0),bt=_t([he("sensor-items-editor")],bt);var yt=function(e,t,i,s){var o,n=arguments.length,a=n<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,s);else for(var r=e.length-1;r>=0;r--)(o=e[r])&&(a=(n<3?o(a):n>3?o(t,i,a):o(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};let $t=class extends ce{constructor(){super(...arguments),this.useSensorSchema=!1,this._schemadomain=ye((()=>[{name:"tap_action",selector:{select:{options:[{label:"None",value:"none"},{label:"Toggle",value:"toggle"},{label:"Popup",value:"popup"}]}}},{name:"color",selector:{ui_color:{default_color:"state",include_state:!0}}},{name:"icon",selector:{icon:{}}}])),this._schemaalert=ye((()=>[{name:"tap_action",selector:{select:{options:[{label:"None",value:"none"},{label:"Popup",value:"popup"}]}}},{name:"color",selector:{ui_color:{default_color:"state",include_state:!0}}},{name:"icon",selector:{icon:{}}}])),this._schemasensor=ye((()=>[{name:"tap_action",selector:{select:{options:[{label:"None",value:"none"},{label:"Popup",value:"popup"}]}}},{name:"color",selector:{ui_color:{default_color:"state",include_state:!0}}}])),this._computeLabelCallback=e=>{switch(e.name){case"icon":return this.hass.localize("ui.panel.lovelace.editor.card.generic.icon");case"color":return this.hass.localize("ui.panel.lovelace.editor.card.tile.color");case"enable_popup_view":return this.hass.localize("ui.common.enable")+" "+this.hass.localize("ui.panel.lovelace.editor.action-editor.actions.more-info");case"disable_toggle_action":return this.hass.localize("ui.common.disable")+" "+this.hass.localize("ui.panel.lovelace.editor.card.generic.tap_action");case"tap_action":return this.hass.localize("ui.panel.lovelace.editor.card.generic.tap_action");default:return this.hass.localize(`ui.panel.lovelace.editor.card.area.${e.name}`)}}}render(){if(!this.hass||!this.config)return V``;let e;switch(this.getSchema){case"sensor":e=this._schemasensor();break;case"domain":e=this._schemadomain();break;case"alert":e=this._schemaalert()}const t=Object.assign({},this._config);return V`
      <ha-form
        .hass=${this.hass}
        .data=${t}
        .schema=${e}
